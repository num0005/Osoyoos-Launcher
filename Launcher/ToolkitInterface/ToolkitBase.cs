...
namespace ToolkitLauncher.ToolkitInterface
{
    ...
    abstract public class ToolkitBase
    {
        ...
        public abstract Task ImportBitmaps(string path, string type, string compression, bool should_clear_old_usage, bool debug_plate = false, bool import_folder = false);
