...
namespace ToolkitLauncher
{
    ...
    {
        [Description("Release - MCC")]
        release_mcc,
        [Description("Release - Standalone")]
        release_standalone,
        [Description("Release - Internal")]
        release_internal,
        [Description("Debug - MCC")]
        debug_mcc,
        [Description("Debug - Standalone")]
        debug_standalone,
    ...
    public partial class PathSettings : Window
    {
        ...
        private void profile_wizard_ok_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(root_directory_path) == false)
            {
        ...
        private void profile_selection_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                int build_type_index = 0;
                string build_type_string = ToolkitProfiles.SettingsList[profile_select.SelectedIndex].build_type;
                if (Enum.IsDefined(typeof(build_type), build_type_string))
                    build_type_index = (int)Enum.Parse(typeof(build_type), build_type_string);
                ...
                build_type.SelectedIndex = build_type_index;
        ...
        void ProfileSave()
        {
            ToolkitProfiles.ProfileSettings settings = new ToolkitProfiles.ProfileSettings
            {
                ...
                build_type = build_type.SelectedItem.ToString(),
    ...
    public class ToolkitProfiles
    {
        ...
        private static List<ProfileSettings> _SettingsList = new List<ProfileSettings>();
        public static List<ProfileSettings> SettingsList => _SettingsList;
...
#nullable restore
        ...
        public static bool Load()
        {
            ...
            if (File.Exists(file_path))
            {
                try
                {
                    ...
                    _SettingsList = JsonSerializer.Deserialize<List<ToolkitProfiles.ProfileSettings>>(jsonString);
                }
        ...
        public static ProfileSettings GetProfile(int index)
        {
        ...
        public static int AddProfile()
        {
            ...
            var profile = new ToolkitProfiles.ProfileSettings();
            profile.profile_name = String.Format("Profile {0}", count);
            profile.build_type = "release_standalone"; // default to this for now
